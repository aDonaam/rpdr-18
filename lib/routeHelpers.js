...
// ============================================================================
// LEGACY: Season 18 specific routes (former /rpdr-18 structure)
// These exist for backward compatibility. Once all pages migrate to the
// new multi-season structure, these can be deprecated.
// ============================================================================
 ...
 */
export function legacyLoginPath() {
  return "/login";
}
 ...
 */
export function legacyLogoutPath() {
  return "/logout";
}
